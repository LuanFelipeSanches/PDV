...
<a href="index.php?pagina=<?php echo $pag ?>&funcao=novo" type="button" class="btn btn-secondary mt-2">Nova Produto</a>
			...
			<table id="example" class="table table-hover my-4" style="width:100%">
				...
				<tbody>
					...
					for ($i = 0; $i < $total_reg; $i++) {
						...
						$query_cat = $pdo->query("SELECT * FROM categorias WHERE id = $id_cat'");
					...
					?>
						...
						<tr>
							...
							<td>
								...
								'<?php echo $res[$i]['foto'] ?>','<?php echo $nome_cat ?>')" title="Ver Descrição">
										<i class="bi bi-card-text text-dark"></i></i>
									</a>
								</a>
							</td>
						</tr>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body mb-4">
				...
				<hr>
				<img id="imagem-registro" src="" class="mt-4" width="300">
			</div>
...
<script type="text/javascript">
	function mostrarDados(descricao, foto, categoria) {
		...
		$('#categoria-registro').text(endereco);
		$('#descricao-registro').text(nome);
